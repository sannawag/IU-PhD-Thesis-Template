...
\section{Data pre-processing details/Format}
...
%We then shift every note by a random amount along the continuous logarithmic scale of cents. We generate 7 detuned versions of each song. 